...
interface ExpenseRepository {
    ...
    fun observeByDateRange(startDate: Long, endDate: Long): Flow<List<Expense>>
    fun observeByType(type: TransactionType): Flow<List<Expense>>
    fun observeTotalByTypeAndDateRange(type: TransactionType, startDate: Long, endDate: Long): Flow<Double>
    ...
    suspend fun getTotalExpensesByCategoryAndDateRange(categoryId: Long, startDate: Long, endDate: Long): Double
}
